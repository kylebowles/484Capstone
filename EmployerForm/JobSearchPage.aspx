                        ...
                        <div class="container">
                            ...
                            <div class="container">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtSearch" name="firstname" placeholder="Work Based Learning Opportunities..." runat="server" />

                                </div>
                                <div class="form-group">
                                    <asp:Label for="TxtOppType" runat="server">Opportunity Type:</asp:Label>
                                    <select class="form-control" id="TxtOppType" placeholder="Select Opprotunity Type..." runat="server">
                                ...
                                <div class="form-group ">
                                    <asp:GridView runat="server" AlternatingRowStyle-BorderStyle="Outset" BackColor="White" BorderStyle="Solid" ForeColor="Black" AutoGenerateColumns="False" DataKeyNames="OpportunityID" DataSourceID="SqlDataSource2" Width="95%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="OpportunityName" HeaderText="Opportunity Name" SortExpression="OpportunityName" />
                                            <asp:BoundField DataField="OpportunityType" HeaderText="Opportunity Type" SortExpression="OpportunityType" />
                                            <asp:BoundField DataField="isApprenticeship" HeaderText="Apprenticeship?" SortExpression="isApprenticeship" />
                                        </Columns>
                                        <RowStyle BackColor="White" BorderColor="Black" BorderStyle="Solid" />
                                    </asp:GridView>
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Cued-InConnectionString %>" SelectCommand="SELECT * FROM [Opportunity]"></asp:SqlDataSource>
                                </div>
