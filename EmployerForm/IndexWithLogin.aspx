<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IndexWithLogin.aspx.cs" Inherits="IndexWithLogin" %>
							...
							<div class="col-xl-10">
                                ...
                                <!-- login credentials/inputs (email and password?) --> 
                                        <div class="form-group row">
                                                ...
                                                <input type="email" class="form-control" id="InputEmail2" aria-describedby="emailHelp" runat="server" placeholder="Enter email">
                                        </div>   
                                        <div class="form-group row">
                                ...
                                <!-- put in correct #href when page is made -->             
                                        <div class="singleService wow fadeInLeft" data-wow-duration="1.8s">
                                            <%--<asp:LinkButton id="loginButton"  class="f2 text-uppercase" runat="server" OnClick="BtnLogin1_Click" />--%>
                                            <a href="#" class="f2 text-uppercase" runat="server" onServerClick="BtnLogin1_Click">login</a>
                                        </div>
                                        </div>
                                        </div>
                                    </div>
